...
//     constructor(VNFT _vnft, IERC20 _muse) public {
//         vnft = _vnft;
//         muse = _muse;
//     }
...
//             players[currentRound].length
//         )];
//         require(muse.transfer(winner2, museBalance));
...
//             players[currentRound].length
//         )];
//         require(muse.transfer(winner3, muse.balanceOf(address(this)) / 2));
...
//             players[currentRound].length
//         )];
//         require(muse.transfer(winner4, muse.balanceOf(address(this))));
