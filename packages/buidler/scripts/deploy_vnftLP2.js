...
async function main() {
  ...
  const VnftLp = await deploy("VnftLp2", ["305857164704083000", VNFT.address]);
  ...
  //   deposit lps
  await VnftLp.deposit(0, "100000000000000000000");
  console.log("🚀 Depsoited 1Lp into pool \n");

  userDeposit = await VnftLp.userInfo(
    0,
    "0xc783df8a850f42e7F7e57013759C285caa701eB6"
  );
  ...
  poolInfo = await VnftLp.poolInfo(
    0
  );
  console.log("pool info: ", poolInfo.toString());
  ...
  console.log("after 1000 blocks, got points: ", pending.toString());
  ...
  console.log("before redeeming: should be 0.33 * 2 *1000 ", pending.toString() + "\n");
  await VnftLp.redeem(0);

  console.log("redeemed 1 pet for 400 points \n");
  ...
  await VnftLp.deposit(0, "100000000000000000000");
  console.log("🚀 Depsoited 100Lp into pool \n");

  pending = await VnftLp.pendingPoints(
    0,
    "0xc783df8a850f42e7F7e57013759C285caa701eB6"
  );
  console.log("after 0 more blocks, got points: ", pending.toString());
  ...
  console.log("after 1000 more blocks, got points should be 200 omething + same amount as first time:  ", pending.toString());
